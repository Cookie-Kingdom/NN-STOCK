...
paragraph(doc, "เอกสารนี้อธิบายความหมายของรหัสที่พบในใบสั่งซื้อ ใบขนส่ง ใบ Invoice และบันทึกการผลิต เพื่อให้ทุกฝ่ายอ้างอิงรายการเดียวกันได้ตลอดเส้นทางตั้งแต่ Food Diva ส่งเนื้อ โรงรมควันผลิต จนกลับเข้าสต๊อกกลาง")
...
add_table(doc,
    ...
    [
        ["PO", "ใบสั่งซื้อเนื้อ", "Owner", "สั่งซื้อเนื้อจาก Food Diva และเป็นจุดเริ่มต้นของรายการ", "PO-2026-0001"],
        ["F", "Lot เนื้อหลัก", "ระบบเมื่อ Owner ออก PO", "ระบุเนื้อชุดเดียวกันตลอดกระบวนการ", "F260913-001"],
        ["Invoice Food Diva", "Invoice เนื้อ", "Food Diva", "ยืนยันน้ำหนักและยอดเนื้อที่ส่งจริงตาม PO", "เลข Invoice ของ Food Diva"],
...
add_table(doc,
    ...
    [
        ...
        ["2", "Invoice Food Diva", "เลข PO Lot น้ำหนักตาม Invoice และน้ำหนักพร้อมส่ง", "Food Diva"],
        ["3", "PO โรงรมควัน", "เลข SO และ Lot เนื้อหลัก อ้างอิง Invoice Food Diva", "Owner"],
        ["4", "Invoice Chef_house", "เลข SO Lot เนื้อ และยอดค่ารมควัน", "Chef_house และ Owner"],
        ["5", "ใบขนส่งขาไป", "เลข TR ต้นทาง Food Diva ปลายทาง Chef_house และน้ำหนักส่ง", "Owner"],
        ...
        ["8", "ใบขนส่งขากลับ", "เลข TR ต้นทาง Chef_house ปลายทาง Food Diva และน้ำหนักหลังรม", "Owner"],
    ],
    [1.3, 4.2, 8.0, 4.0],
)
...
paragraph(doc, "เลข Invoice ของ Food Diva และ Chef_house เป็นเลขที่คู่ค้าเป็นผู้ระบุ ระบบจัดเก็บเพื่อเชื่อมกับ PO และ Lot ไม่ได้ออกเลข Invoice แทนคู่ค้า")
