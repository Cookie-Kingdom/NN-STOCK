  ...
  return (
    <DataTable
      ...
      rows={[
        ...
        ["ตรวจนับจริงปลายวัน", actual === null ? "ยังไม่ได้ตรวจนับ" : fmt(actual), mismatch ? <Badge tone="danger">ยอดไม่ตรง</Badge> : actual === null ? "กรอกได้ในฟอร์มยอดขาย" : <Badge tone="success">ตรงกัน</Badge>],
