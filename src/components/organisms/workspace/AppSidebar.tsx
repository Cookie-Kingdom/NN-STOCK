            ...
            {group.items.map((item) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "flex cursor-pointer items-center gap-3 rounded-md p-3 text-left transition-colors max-md:gap-1.5 max-md:p-2.5 max-md:text-caption max-md:whitespace-nowrap",
                    selected
