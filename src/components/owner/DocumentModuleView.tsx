...
import { averageYield, entries, n, processLoss, processed, produced, rawAtFoodDiva, rawAtSmoker, smokingInvoiceStatus, steakRawStock, type Database } from "@/lib/store";
