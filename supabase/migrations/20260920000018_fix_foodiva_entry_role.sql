-- Foodiva could not save anything: every write came back "Entry role does not match
-- signed-in account".
--
-- 20260915000011 renamed the misspelled role to "foodiva" everywhere, in stored history and
-- in this function. 20260920000016 was written from the pre-rename copy and brought the old
-- spelling back, and 20260920000017 inherited it, so an L4_SUPPLIER account was checked
-- against a role no client writes any more.
--
-- Identical to 20260920000017 apart from that one word.
