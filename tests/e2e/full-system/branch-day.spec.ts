...
test("Lane E: จัดสรร → สาขาศาลาแดง/มีนบุรี รับ ละลาย ข้าว ขาย เช็ควัสดุ ปิดวัน → Owner ปลดล็อก รายงาน สต๊อก (E1–E12)", async ({
  ...
  await step(
    page,
    "สาขาศาลาแดง: E2 รับของ — เห็นเฉพาะใบจัดสรรของตัวเอง (ค้างรับ 300 กก. 3 ถุง)",
    async () => {
  ...
  await step(
    page,
    "สาขาศาลาแดง: E2 รับ 290 ≠ 300 → กรอกเหตุผลส่วนต่าง · รับ 300 → ผ่าน",
    async () => {
  ...
  await step(
    page,
    "สาขาศาลาแดง: E4 แบ่งละลาย 400 > 300 → สต๊อกแช่แข็งไม่พอ · 50 กก. → ผ่าน",
    async () => {
  ...
  await step(
    page,
    "สาขาศาลาแดง: E4 สต๊อก — รับแล้ว 300 · แช่แข็ง 250 · พร้อมขาย 50",
    async () => {
  ...
  await step(
    page,
    "สาขาศาลาแดง: E5 เบิกข้าวดิบ 25 > 20 → ข้าวเหนียวดิบในสต๊อกไม่พอ · เบิก 10 → ผ่าน",
    async () => {
  ...
  await step(
    page,
    "สาขาศาลาแดง: E5 หุงข้าว 15 > เบิก 10 → บล็อก · ดิบ 10 → สุก 20 กก.",
    async () => {
  ...
  await step(
    page,
    "สาขาศาลาแดง: E5 สรุปสาขา — ข้าวดิบ 10 · เบิกค้าง 0 · ข้าวสุก 20 · น้ำพริกจัดสรร 50 คงเหลือ 50",
    async () => {
      ...
      await expect(
        cell(summary(page), "ข้าวเหนียวดิบที่เบิกแล้วยังไม่หุง", 1),
      ).toHaveText("0.00");
      await expect(cell(summary(page), "ข้าวเหนียวสุกคงเหลือ", 1)).toHaveText(
        "20.00",
      );
      await expect(
        cell(summary(page), "น้ำพริกที่ Owner จัดสรร", 1),
      ).toHaveText("50");
      await expect(
      ...
      await nav(page, "กรอกรายวัน");
      await expect(
        cell(tableSection(page, /^น้ำพริกหลอด/), "ยอดตั้งต้นจาก Owner", 1),
      ).toHaveText("50.00");
    },
  );
  ...
  await step(
    page,
    "สาขาศาลาแดง: E10 ปิดวัน 18:00 → ปิดวันได้ตั้งแต่ 22:00 (นาฬิกาจำลอง)",
    async () => {
      await closeDayRefused(
        page,
        "18:00",
        /ปิดวันได้ตั้งแต่ 22:00 \(นาฬิกาจำลอง\)/,
      );
    },
  );
  ...
  await step(
    page,
    "สาขาศาลาแดง: E10 ปิดวัน 22:00 ก่อนขาย → ยังไม่มีรายการขายวันนี้",
    async () => {
  ...
  await step(
    page,
    "สาขาศาลาแดง: E7 ยอดขาย — กล่อง 2.5 → จำนวนขายต้องเป็นจำนวนเต็ม",
    async () => {
      await openSale(page);
  ...
  await step(
    page,
    "สาขาศาลาแดง: E7 50 กล่อง + 10 add-on + 20 น้ำพริก = ฿21,300 ตามเมนู · Waste 50 → เกินเนื้อพร้อมขาย",
    async () => {
  ...
  await step(
    page,
    "สาขาศาลาแดง: E7 Waste 0.5 → ผ่าน · สรุปสาขา ยอดขาย LINE MAN 21,300 · พร้อมขายเหลือ 43.5",
    async () => {
      ...
      await expect(cell(summary(page), "เนื้อพร้อมขายทั้งหมด", 1)).toHaveText(
        "43.50",
      );
      await expect(cell(summary(page), "ข้าวเหนียวสุกคงเหลือ", 1)).toHaveText(
        "10.00",
  ...
  await step(
    page,
    "สาขาศาลาแดง: E10 ปิดวันก่อนเช็ควัสดุ → ยังไม่เช็ควัสดุวันนี้",
    async () => {
  ...
  await step(
    page,
    "สาขาศาลาแดง: E8 กล่องโปรโมท 2.5 → จำนวนที่ส่งต้องเป็นจำนวนเต็ม · 5 กล่อง 0.5 กก. → หักเนื้อ ไม่นับรายได้",
    async () => {
      await pointAndClick(
        page,
  ...
  await step(
    page,
    `สาขาศาลาแดง: E9 ใช้ 150 > 100 → จำนวนใช้ ${BOX} เกินยอดตั้งต้น`,
    async () => {
  ...
  await step(
    page,
    "สาขาศาลาแดง: E9 ตรวจนับ -1 → บล็อก (ตั้งแต่ศูนย์) · 2.5 → วัสดุต้องเป็นจำนวนเต็ม",
    async () => {
  ...
  await step(
    ...
    async () => {
      ...
      await expect(
        daily.getByRole("button", { name: "บันทึกแก้ไข" }),
      ).toBeVisible();
      await nav(page, "สต๊อก");
  ...
  await step(
    page,
    "สาขาศาลาแดง: E10 ปิดวันขณะเหลือพร้อมขาย 43 กก. → ยังมีเนื้อพร้อมขาย ต้องบันทึกขายหรือ Waste ให้เป็นศูนย์",
    async () => {
      await closeDayRefused(
        page,
        "22:00",
  ...
  await step(
    page,
    "สาขาศาลาแดง: E10 บันทึก Waste 43 กก. ให้เนื้อพร้อมขายเป็นศูนย์",
    async () => {
      await openSale(page);
  ...
  await step(
    page,
    "สาขาศาลาแดง: E10 ปิดวัน 22:00 → สำเร็จ · ทุกปุ่มบันทึกล็อก · สรุปสาขา",
    async () => {
      ...
      await expect(cell(summary(page), "ตรวจนับวัสดุ", 2)).toHaveText(
        "บันทึกแล้ว",
      );
    },
  );
  ...
  await step(
    page,
    "สาขามีนบุรี: E3 รับของ — ไม่เห็นใบของศาลาแดง · รับ 2 ถุง 200 กก.",
    async () => {
      ...
      await expect(allocation.locator("option").nth(1)).not.toContainText(
        "300.00",
      );
      await allocation.selectOption({ index: 1 });
  ...
  await step(
    page,
    "สาขามีนบุรี: E6 ไม่มีขั้นตอนเบิกข้าวดิบ/หุงข้าว · ซื้อข้าวสุก 20 < ฐาน 30 → บล็อก · 32 กก. → ผ่าน",
    async () => {
      ...
      await expect(
        openDialog(page).getByLabel(/ข้าวเหนียวดิบซื้อเข้า/),
      ).toHaveCount(0);
      ...
      await submitAndExpectError(
        page,
        /ยอดข้าวเหนียวสุกหลังซื้อควรมีอย่างน้อย 30 กก\./,
      );
  ...
  await step(
    page,
    "สาขามีนบุรี: แบ่งละลาย 2 กก. · ขาย 10 กล่อง 1.0 กก. Waste 1.0 · LINE MAN 3,500",
    async () => {
      await button(page, "แบ่งละลาย");
  ...
  await step(
    page,
    "สาขามีนบุรี: เช็ควัสดุ (ยังไม่มีวัสดุ) · ปิดวันก่อนยืนยันข้าวสุก → ยังไม่ยืนยันข้าวเหนียวสุกคงเหลือ",
    async () => {
      await button(page, "บันทึกการใช้วัสดุ");
      await expect(page.getByText("บันทึกการใช้วัสดุวันนี้แล้ว")).toBeVisible();
  ...
  await step(
    page,
    "สาขามีนบุรี: ยืนยันข้าวสุกคงเหลือ 30 กก. · ปิดวัน 22:00 → สำเร็จ",
    async () => {
  ...
  await step(
    page,
    "สาขามีนบุรี: E12 สต๊อก — เนื้อ 198 แช่แข็ง / 0 พร้อมขาย · ข้าวสุก 30 · น้ำพริก 20",
    async () => {
      await nav(page, "สต๊อก");
      const stock = tableSection(page, "สต๊อกเนื้อ · มีนบุรี");
  ...
  await step(
    page,
    "Owner: E11 ปลดล็อกวันศาลาแดง → รายงานรายวัน ศาลาแดง เปิดอยู่ · มีนบุรี ปิดแล้ว",
    async () => {
      await signInAs(page, ACCOUNTS.owner);
      await button(page, "รายงาน");
      await button(page, "ปลดล็อกวัน");
  ...
  await step(
    page,
    "สาขาศาลาแดง: E12 สต๊อก — เนื้อ 249.80 แช่แข็ง / 0 พร้อมขาย · ข้าวดิบ 10 · ข้าวสุก 8.60 · น้ำพริก 30 · กล่อง 70",
    async () => {
      await nav(page, "สต๊อก");
      const stock = tableSection(page, "สต๊อกเนื้อ · ศาลาแดง");
  ...
  await step(
    page,
    "Owner: E11 รายงาน — ยอดขายสะสม ศาลาแดง 22,000 · มีนบุรี 3,500 · รวม 25,500 ทั้งสองวันปิดแล้ว",
    async () => {
      await signInAs(page, ACCOUNTS.owner);
      await button(page, "รายงาน");
